...
//			}
		...
		else if(pbuf[0] == ANSWER_PKT_HEADER1 && szbuf == ANSWER_PKT_SIZE1)
		{
			...
			env->gps_x=(double)locationlat*10000000;
			env->gps_y=(double)locationlng*10000000;
			...
			rt_int16_t ptzdistance_int=(rt_int16_t)(env->laser_dis*10.0f);
			data_send_plane[13]=0x01;
			...
			rt_int16_t ptzyaw_int=(rt_int16_t)(allyaw*100.0f);
			...
			{
				rt_device_write(dev5, 0, data_send_plane, 20);
			}
		}
		//laokuan jiguangqi
