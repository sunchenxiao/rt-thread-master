...
#define SENDID_SIZE   (13)
rt_uint8_t send_id[SENDID_SIZE]={0x45,0x48,0x41,0x4E,0x47,0x45,0x48,0x41,0x4E,0x47,0x02,0x00,0x01};
...
void zingto_resolving_entry(void* parameter)
{
    ...
    while (1)
    {
        ...
        if(pbuf[0]==0x45&&pbuf[1]==0x48&&pbuf[2]==0x41&&pbuf[3]==0x4E&&pbuf[4]==0x47&&pbuf[11]==0x00&&pbuf[12]==0x01)
		{
			rt_device_write(dev, 0, send_id, SENDID_SIZE);
			szbuf = 0;
			continue;
		} 
