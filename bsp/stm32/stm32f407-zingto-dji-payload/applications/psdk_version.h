...
#define PSDK_VERSION_MODIFY    0 /*!< Payload SDK modify version num, when have backwards compatible bug fixes changes. Range from 0 to 99. */
...
#define PSDK_VERSION_BUILD     262 /*!< Payload SDK version build info, when jenkins trigger build changes. Range from 0 to 65535. */
