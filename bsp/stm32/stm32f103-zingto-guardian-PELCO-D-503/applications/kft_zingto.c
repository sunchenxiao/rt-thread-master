...
//    rt_device_control(dev, RT_DEVICE_CTRL_CONFIG, &config);    
    ...
    while (1)
    {
		...
		{
			env->trck_offset_x=((pbuf[4]-128)*1920/256+65536)%65536;
			env->trck_offset_y=((pbuf[5]-128)*1080/256+65536)%65536;
		...
		{
			env->cam_zoom_speed_uart = pbuf[4];
