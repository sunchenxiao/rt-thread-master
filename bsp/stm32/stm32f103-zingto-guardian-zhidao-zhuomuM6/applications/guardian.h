...
#define PANTILT_ACTION_POINTMOVE   		(0x09)
...
#define TRACK_ACTION_DETECT_START		(0x0A)
#define TRACK_ACTION_DETECT_STOP		(0x0B)
#define TRACK_ACTION_DETECT_TRACK_START	(0x0C)
#define TRACK_ACTION_DETECT_TRACK_STOP	(0x0D)
...
struct guardian_environment
{
    ...
    rt_sem_t        sh_track;
	rt_int32_t		trck_offset_x;
	rt_int32_t		trck_offset_y;
};
