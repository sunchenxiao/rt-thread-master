...
//    rt_device_control(dev, RT_DEVICE_CTRL_CONFIG, &config);
    ...
    while (1)
    {
		...
		else if (env->trck_action == TRACK_ACTION_PIP_MODE1)
        {
            ctrlpkt.set_mode = 0x85;
            ctrlpkt.set_video_source = 0x00;
            
        }
		else if (env->trck_action == TRACK_ACTION_PIP_MODE2)
        {
            ctrlpkt.set_mode = 0x85;
            ctrlpkt.set_video_source = 0x01;
            
        }
		else if (env->trck_action == TRACK_ACTION_PIP_MODE3)
        {
            ctrlpkt.set_mode = 0x85;
            ctrlpkt.set_video_source = 0x02;
           
        }
		else if (env->trck_action == TRACK_ACTION_PIP_MODE4)
        {
            ctrlpkt.set_mode = 0x85;
